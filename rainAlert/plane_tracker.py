...
class PlaneTracker:
    ...
    def detect_features(self, frame):
        ...
        type = "ORB"
        self.surf = cv2.FeatureDetector_create(type)
        self.surfDescrp = cv2.DescriptorExtractor_create(type)
        keypoints = self.surf.detect(frame)
        keypoints, descrs = self.surfDescrp.compute(frame,keypoints)
